!function(t, e, i, n) {
	...
	function D(t, e) {
		...
		var r=i.firstInput,
		o=i.firstMultiple,
		a=o?o.center: r.center, l=e.center=P(n);
		e.timeStamp=gt(),
		...
		e.overallVelocity=mt(c.x)>mt(c.y)?c.x: c.y, e.scale=o?X(o.pointers, n):1, e.rotation=o?N(o.pointers, n):0, e.maxPointers=i.prevInput?e.pointers.length>i.prevInput.maxPointers?e.pointers.length:i.prevInput.maxPointers:e.pointers.length, S(i, e);
		var h=t.element;
	...
	function S(t, e) {
		...
		if(e.eventType !=Mt&&(s>bt||i.velocity===n)) {
			...
			o=u.x,
			a=u.y,
			r=mt(u.x)>mt(u.y)?u.x: u.y, l=R(c, h), t.lastInterval=e
		}
	...
	function b(t) {
		for(var e=[], i=0; i<t.pointers.length; )e[i]= {
			clientX: vt(t.pointers[i].clientX), clientY:vt(t.pointers[i].clientY)
		}
	...
	function P(t) {
		...
		if(1===e)return {
			x: vt(t[0].clientX), y:vt(t[0].clientY)
		}
	...
	function H(t, e) {
		...
		s++;
		return a.length?[y(r.concat(a), "identifier",  !0),
		a]:void 0
	}
...
var yt=a(function we(t, e, i) {
		for(var s=Object.keys(e), r=0; r<s.length; )( !i||i&&t[s[r]]===n)&&(t[s[r]]=e[s[r]]), r++; return t
	}
...
var Vt= {
	mousedown: Pt, mousemove:Ot, mouseup:Rt
}
...
l(Y, I, {
	handler:function De(t) {
		var e=Vt[t.type]; e&Pt&&0===t.button&&(this.pressed= !0), e&Ot&&1 !==t.which&&(e=Rt), this.pressed&&(e&Rt&&(this.pressed= !1), this.callback(this.manager, e, {
...
l(k, I, {
	handler:function _e(t) {
		var e=this.store, i= !1, n=t.type.toLowerCase().replace("ms", ""), s=Gt[n], r=Bt[t.pointerType]||t.pointerType, o=r==At, a=g(e, t.pointerId, "pointerId"); s&Pt&&(0===t.button||o)?0>a&&(e.push(t), a=e.length-1):s&(Rt|Mt)&&(i= !0), 0>a||(e[a]=t, this.callback(this.manager, s, {
...
l(q, I, {
	handler:function Se(t) {
		var e=Kt[t.type]; if(e===Pt&&(this.started= !0), this.started) {
			var i=F.call(this, t, e); e&(Rt|Mt)&&i[0].length-i[1].length===0&&(this.started= !1), this.callback(this.manager, e, {
...
l(W, I, {
	handler:function be(t) {
		var e=ee[t.type], i=H.call(this, t, e); i&&this.callback(this.manager, e, {
			pointers:i[0], changedPointers:i[1], pointerType:At, srcEvent:t
		})
}
});
...
l(L, I, {
	handler:function Pe(t, e, i) {
		var n=i.pointerType==At, s=i.pointerType==_t; if( !(s&&i.sourceCapabilities&&i.sourceCapabilities.firesTouchEvents)) {
			if(n)V.call(this, e, i); else if(s&&j.call(this, i))return; this.callback(t, e, i)
		}
	}
...
l(et, J, {
	...
	, process:function(t) {
		var e=this.state, i=t.eventType, n=e&(ve|me), s=this.attrTest(t); return n&&(i&Mt|| !s)?e|ye:n||s?i&Rt?e|ge:e&ve?e|me:ve:Ce
	}
...
l(it, et, {
	...
	, getTouchAction:function() {
		var t=this.options.direction, e=[]; return t&qt&&e.push(de), t&Ft&&e.push(ue), e
	}

	, directionTest:function(t) {
		var e=this.options, i= !0, n=t.distance, s=t.direction, r=t.deltaX, o=t.deltaY; return s&e.direction||(e.direction&qt?(s=0===r?zt:0>r?Nt:Xt, i=r !=this.pX, n=Math.abs(t.deltaX)):(s=0===o?zt:0>o?Yt:kt, i=o !=this.pY, n=Math.abs(t.deltaY))), t.direction=s, i&&n>e.threshold&&s&e.direction
	}
	...
	, emit:function(t) {
		this.pX=t.deltaX, this.pY=t.deltaY; var e=Q(t.direction); e&&(t.additionalEvent=this.options.event+e), this._super.emit.call(this, t)
	}
...
l(st, J, {
	...
	, process:function(t) {
		var e=this.options, i=t.pointers.length===e.pointers, n=t.distance<e.threshold, r=t.deltaTime>e.time; if(this._input=t,  !n|| !i||t.eventType&(Rt|Mt)&& !r)this.reset(); else if(t.eventType&Pt)this.reset(), this._timer=s(function() {
				this.state=Te, this.tryEmit()
			}

			, e.time, this); else if(t.eventType&Rt)return Te; return Ce
	}
...
l(ot, et, {
	defaults: {
		event:"swipe", threshold:10, velocity:.3, direction:qt|Ft, pointers:1
	}
	...
	, attrTest:function(t) {
		var e=this.options.direction, i; return e&(qt|Ft)?i=t.overallVelocity:e&qt?i=t.overallVelocityX:e&Ft&&(i=t.overallVelocityY), this._super.attrTest.call(this, t)&&e&t.offsetDirection&&t.distance>this.options.threshold&&t.maxPointers==this.options.pointers&&mt(i)>this.options.velocity&&t.eventType&Rt
	}

	, emit:function(t) {
		var e=Q(t.offsetDirection); e&&this.manager.emit(this.options.event+e, t), this.manager.emit(this.options.event, t)
	}
...
l(at, J, {
	...
	, process:function(t) {
		var e=this.options, i=t.pointers.length===e.pointers, n=t.distance<e.threshold, r=t.deltaTime<e.time; if(this.reset(), t.eventType&Pt&&0===this.count)return this.failTimeout(); if(n&&r&&i) {
			if(t.eventType !=Rt)return this.failTimeout(); var o=this.pTime?t.timeStamp-this.pTime<e.interval: !0, a= !this.pCenter||M(this.pCenter, t.center)<e.posThreshold; this.pTime=t.timeStamp, this.pCenter=t.center, a&&o?this.count+=1:this.count=1, this._input=t; var l=this.count%e.taps; if(0===l)return this.hasRequireFailures()?(this._timer=s(function() {
						this.state=Te, this.tryEmit()
					}
...
ct.prototype= {
	...
	recognize:function(t) {
		...
		if( !e.stopped) {
			...
			e.stopped===xe||s&&i !=s&& !i.canRecognizeWith(s)?i.reset(): i.recognize(t),  !s&&i.state&(ve|me|ge)&&(s=e.curRecognizer=i), r++
		}
	}
...
$(document).ready(function() {
		function t(t) {
			var n=$(".side-nav").find(".is-active"), s=$(".side-nav").children().index(n), r=$(".side-nav").children().length-1, o=0; "swipeup"===t.type||40===t.keyCode||t>0?s !==r?(o=s+1, e(o), i(s, o, r)):(e(o), i(s, o, r)):("swipedown"===t.type||38===t.keyCode||0>t)&&(0 !==s?(o=s-1, e(o), i(s, o, r)):(o=r, e(o), i(s, o, r)))
		}
		...
		function s() {
			$(".slider--prev, .slider--next").click(function() {
					var t=$(this), e=$(".slider").find(".slider--item-left"), i=$(".slider").children().index(e), n=$(".slider").find(".slider--item-center"), s=$(".slider").children().index(n), r=$(".slider").find(".slider--item-right"), o=$(".slider").children().index(r), a=$(".slider").children().length, l=$(".slider--item-left"), c=$(".slider--item-center"), h=$(".slider--item-right"), u=$(".slider--item"); $(".slider").animate({
						opacity:0
					}
...
function r() {
	$(".work-request--information input").focusout(function() {
			var t=$(this).val(); ""===t?$(this).removeClass("has-value"):$(this).addClass("has-value"), window.scrollTo(0, 0)
		})
}

var o= !0, a=null; $(this).on("mousewheel DOMMouseScroll", function(e) {
		if( !$(".outer-nav").hasClass("is-vis")) {
			e.preventDefault(); var i=e.originalEvent.wheelDelta?-e.originalEvent.wheelDelta:20*e.originalEvent.detail; i>50&&o?(o= !1, clearTimeout(a), a=setTimeout(function() {
						o= !0
					}
		...
		if( !$(this).hasClass("is-active")) {
			var t=$(this), n=t.parent().find(".is-active"), s=t.parent().children().index(n), r=t.parent().children().index(t), o=$(this).parent().children().length-1; e(r), i(s, r, o)
		}

	}), $(".cta").click(function() {
		var t=$(".side-nav").find(".is-active"), n=$(".side-nav").children().index(t), s=$(".side-nav").children().length-1, r=s; e(s), i(n, r, s)

	}); var l=document.getElementById("viewport"), c=new Hammer(l); c.get("swipe").set({
